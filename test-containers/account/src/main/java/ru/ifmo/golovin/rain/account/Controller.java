package ru.ifmo.golovin.rain.account;
...
public class Controller {
    ...
    @RequestMapping("/sale")
    public String sale(String name, String company, int count) throws IOException, InterruptedException {
        return this.handlers.doSale(name, company, count);
    }
}
